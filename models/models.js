...
class CardMember extends Sequelize.Model {}
CardMember.init(
	{
		card_id: Sequelize.INTEGER,
		member_id: Sequelize.INTEGER
	},
	{ sequelize: sequelize, modelName: 'card_member', timestamps: false }
);
...
// card
Card.belongsToMany(Members, { through: 'card_member', foreignKey: 'card_id' });
Members.belongsToMany(Card, {
	through: 'card_member',
	foreignKey: 'member_id'
});
